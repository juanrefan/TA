		...
		<div class="col-md-7">
			...
			<table border="1" class="table table-striped">
				...
				<tbody>
					<?php 
					$no = 1;
					$data = mysqli_query($conn,"select * from tbmutasi");
					while($d=mysqli_fetch_array($data)){
						?>
						<tr>
							<td><?php echo $no++; ?></td>
							<td><?php echo $d['no_reg']; ?></td>
							<td><?php echo $d['no_surat_perjanjian']; ?></td>
							<td><?php echo $d['pembeli_nama']; ?></td>
							<td><?php echo $d['penjual_nama']; ?></td>
			...
			data: {
				...
				datasets: [{
                    ...
                    $tgl_akhir = $_POST['tgl_akhir'];
                        ...
                        $diterima = mysqli_query($conn,"SELECT * FROM tbmutasi 
					...
					<?php 
                        ...
                        $ditolak = mysqli_query($conn,"SELECT * FROM tbmutasi 
				   ...
				   $perbaiki = mysqli_query($conn,"SELECT * FROM tbmutasi 
				   ...
				   $diproses = mysqli_query($conn,"SELECT * FROM tbmutasi 
