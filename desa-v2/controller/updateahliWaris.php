...
function uploadBerkas(){
    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allowEkstensi) == TRUE){
            ...
            $sql = "CALL updateahliWaris('$id', '$no_reg','$tanggal', '$namaPemohon', '$warisIstri', '$warisSuami', '$tanggalmeninggalIstri', '$tanggalmeninggalSuami', '$alamatMeninggal', '$namaahliWaris', '$umur', '$hubunganKeluarga', '$alamat','$suratketeranganahliWarisFile', '$aktaketeranganhakMewarisFile', '$suratpernyataanahliWarisFile'
            ,'$status')";
            ...
            if ($conn->query($sql) === true) {
                ...
                echo '<script language="javascript">';
                echo 'alert("Data sukses diubah"); location.href="http://localhost/Admin_perkades"';
                echo '</script>';
