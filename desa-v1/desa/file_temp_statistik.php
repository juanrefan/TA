		...
		<div class="col-md-3">
			<form action="" method="POST" class="form">
				<div class="form-group">
					...
					<input type="text" name="tgl_awal" class="form-control" id="datepicker1" >
				...
				<tbody>
					...
					while($d=mysqli_fetch_array($data)){
						...
						<tr>
							...
							<td><?php if($d['status_pengajuan']==1){echo "Diterima";}else{echo "Ditolak";} ?></td>
						</tr>
						<?php 
					}
					?>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					WHERE tanggal BETWEEN $tgl_awal AND $tgl_akhir AND  status_pengajuan=1");
					echo mysqli_num_rows($diterima);
					?>, 
					<?php 
					$ditolak = mysqli_query($conn,"SELECT * FROM tbsertifikat
					WHERE tanggal BETWEEN $tgl_awal AND $tgl_akhir AND  status_pengajuan=2");
