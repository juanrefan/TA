...
function upload_berkas(){
    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allow_ekstensi)===TRUE){
            ...
            // Query Input/Insert 
            $sql = "CALL insertdataSertifikat(-1, '$no_reg', '$tanggal', '$firstName', '$lastName', '$alamatPemohon', '$pengajuanAJB', 
            ...
            if ($conn->query($sql) === true) {
                ...
                echo '<script language="javascript">';
                echo 'alert("Successfully Registered"); location.href="http://localhost/warga_sertifikat"';
                echo '</script>';
