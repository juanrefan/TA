    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allowEkstensi)==TRUE){
            ...
            if ($files['file']['size'][0]>200000 AND $files['file']['size'][1]>200000 AND $files['file']['size'][2]>200000) {
                ...
                echo 'alert("Ukuran file melebihi kapasitas 200kb"); location.href="http://localhost/warga_mutasi"';
                echo '</script>';
            ...
            $no_persil_penjual = filter_input(INPUT_POST, "no_persil_penjual");
            ...
            $statusTanah = filter_input(INPUT_POST, "status_tanah");
            ...
            $sql = "Call insertdatatbmutasi(-1,'$no_reg','$no_surat_perjanjian', '$penjual_nama', '$penjual_tanggal_lahir', '$penjual_alamat', '$pembeli_nama', '$pembeli_tanggal_lahir', '$pembeli_alamat', '$no_kikitir', '$no_persil_penjual','$no_persil','$ds', '$batas_tanah', '$luas_tanah', '$harga', '$mutlak_akad', '$ajb', '$sertifikat', '$pph'
            ,'$statusTanah','$status')";
                ...
                // echo "New record created successfully";
                   ?>
                       <script>
                        ...
                        location.href = "http://localhost/warga_sertifikat";
                    </script>
            ...
            echo '<script language="javascript">';
            echo 'alert("Tidak support jenis file"); location.href="http://localhost/warga_mutasi"';
            echo '</script>';
        }
