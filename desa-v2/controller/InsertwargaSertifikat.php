    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allow_ekstensi)===TRUE){
            ...
            if ($files['file']['size'][0]>200000 AND $files['file']['size'][1]>200000 AND $files['file']['size'][2]>200000 AND $files['file']['size'][3]>200000  ) {
                ...
                echo 'alert("Ukuran file melebihi kapasitas 200kb"); location.href="http://localhost/warga_sertifikat"';
                echo '</script>';
            ...
            $jenisTanah = filter_input(INPUT_POST, "status_tanah");
            ...
            if ($conn->connect_error) {
             ...
             if($result->num_rows>0){
                ...
                $sql = "CALL insertdataSertifikat(-1, '$no_reg', '$tanggal', '$firstName', '$lastName','$alamatPemohon','$kikitir', '$no_desa', '$blok','$persil', '$luasTanah', '$batasTanah', '$keterangan', '$ktp', '$kk', '$pbb', '$buktiSurat','$status','$jenisTanah')";
