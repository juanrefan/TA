...
?>
<td><a href="controller/deleteMutasi.php?id=<?php echo $result["id"]  ?>"> <button type="button" name="delete" class="btn btn-primary">Delete</button></a></td>
      ...
      <div class="w3-container">
        ...
        <form action="controller/updateMutasi.php" method="POST" enctype="multipart/form-data">
            <div class="form-columns">
              ...
              <label for="akad">Mutlak Akad<span class="required">*</span></label>
              <input type="text" id="mutlak_akad" name="mutlak_akad" value="<?php echo $result["mutlak_akad"] ?>" class="field-divided" placeholder="Akad">
              <label for="ktp">AJB`:</label>
            ...
            <div style="clear:both">
              <input id="btnAction" type="submit" value="Submit" button="btnAction">
            </div>
          </form>
