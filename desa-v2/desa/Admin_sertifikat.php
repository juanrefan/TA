  ...
  <?php  include_once "controller/registrasiSertifikat.php"; ?>
        ...
        <h2 align="center">Admin Table Sertifikat</h2>
       
        <div class="container">
            <div class="dropdown">
                <button type="button" class="btn btn-primary" data-toggle="dropdown">
                    Notifications <span class="badge badge-danger" id="notifsertifikat"></span>
                </button>
        ...
        <div class="w3-container">
          ...
          <div class="w3-modal-content" style="width: 100%">
              <div class="w3-container">
                ...
                <form action="controller/insertadminSertifikat.php" method="POST" enctype="multipart/form-data">
                    <div class="form-columns">
                      ...
                      <div class="form-style-1">
                                ...
                                <input type="text" id="tgl" name="tanggal" value=" <?php echo date('m/d/Y'); ?>" readonly="true" class="field-divided" placeholder="Tanggal Peraturan Desa">
        ...
        <div class="w3-modal-content" style="width: 75%">
            <div class="w3-container">
              ...
              <form action="controller/update_status_Sertifikat.php" method="POST" enctype="multipart/form-data">
                  <div class="form-columns">
                    <div class="form-style-1">
               
                              <input type="hidden" name="id" value="<?php echo $result["id"] ?>">
                              <input type="text" readonly="true" name="no_reg_sertifikat" value="<?php echo $result["no_reg"] ?>"><br>
                              <label for="tanggal">Tanggal<span class="required">*</span></label>
    ...
    <!-- Start Modal View -->
    <div class="w3-container">
        <div id="<?php echo 'view'.$result['id'] ?>" class="w3-modal">
        <div class="w3-modal-content" style="width: 75%">
            <div class="w3-container">
              <span onclick="document.getElementById('<?php echo 'view'.$result['id'] ?>').style.display='none'" class="w3-button w3-display-topright">&times;</span>
           
              <div class="form-columns">
                    <div class="form-style-1">
               
                              <input type="hidden" name="id" value="<?php echo $result["id"] ?>">
                              <input type="text" class="form-control" disabled="true" name="no_reg_sertifikat" value="<?php echo $result["no_reg"] ?>"><br>
                              <label for="tanggal">Tanggal<span class="required">*</span></label>
                              <input type="date" disabled="true"  id="tgl" name="tanggal" value="<?php echo $result["tanggal"] ?>" class="field-divided" placeholder="Tanggal Peraturan Desa">
                              
                              <label for="firstName">Nama Pemohon<span class="required">*</span></label>
                              <input type="text" disabled="true"  id="firstName" name="firstname" value="<?php echo $result["first_name"] ?>" class="field-divided" placeholder="First">
                              
                              <input type="text" disabled="true"  name="lastname" value="<?php echo $result["last_name"] ?>" class="field-divided" placeholder="Last" id="lastName">
                              <label for="alamatPemohon">Alamat Pemohon<span class="required">*</span></label>
                              <input type="text" disabled="true"  id="alamatPemohon" name="alamatpemohon" value="<?php echo $result["alamat_pemohon"] ?>" class="field-divided">
                              
                                
                              <label for="kikitirNo">Kikitir no. <span class="required">*</span></label>
                              <input type="date" disabled="true"  id="kikitirNo" name="kikitir" value="<?php echo $result["kikitir_no"] ?>" class="field-divided" placeholder="First">
                              ...
                              <label for="noDesa">No C Desa<span class="required">*</span></label>
                              <input type="text" disabled="true"  name="nodesa" id="noDesa" value="<?php echo $result["no_c_desa"] ?>" class="field-divided" placeholder="First">
                              
                              <label for="blok">Blok<span class="required">*</span></label>
                              <input type="text" disabled="true"  name="blok" id="blok"  value="<?php echo $result["blok"] ?>" class="field-divided" placeholder="First">
                      <!-- form fields -->
                    </div>
                    <div class="form-style-2">
                    <label for="persil">Persil<span class="required">*</span></label>
                              <input type="text" disabled="true"  name="persil" id="persil" value="<?php echo $result["persil"] ?>" class="field-divided" placeholder="First">
                             
                              <label for="luasTanah">Luas Tanah<span class="required">*</span></label>
                              <input type="text" disabled="true"  name="luastanah" id="luasTanah" value="<?php echo $result["luas_tanah"] ?>" class="field-divided" placeholder="First">
                            
                              <label for="batastanah">Batas-batas Tanah<span class="required">*</span></label>
                              <input type="text" disabled="true"  name="batastanah" id="batasTanah" value="<?php echo $result["batas_tanah"] ?>" class="field-divided" placeholder="First">
        <!--                     
                              <label for="noPbb">No PBB<span class="required">*</span></label>
                              <input type="text" name="nopbb" id="noPbb" value="<?php echo $result["no_pbb"] ?>" class="field-divided" placeholder="First"> -->
                              
                              <label for="keterangan">Keterangan<span class="required" id="keterangan">*</span></label>
                              <textarea name="keterangan" disabled="true"  id="keterangan" class="field-long field-textarea" style="width:500
                              px"></textarea>
                              ...
                              <label for="buktiSurat">Bukti Surat:</label><br>
                              <img src="../Sertifikat/registrasiSertifikat/<?php echo $result["buktisuratLain"] ?>" width="500" height="600"><br>
        
                              <label for="status">Status dokumen:</label>
                                <select id="status" disabled="true"  name="status" class="form-control">
                                  <option value="Diterima">Diterima</option>
                                  <option value="Ditolak">Ditolak</option>
                                  <option value="Perbaiki">Perbaiki</option>
                                </select>
         ...
         <td>
          <button onclick="document.getElementById('<?php echo 'view'.$result['id']?>').style.display='block'" class="btn btn-primary">View</button>
        </td>
              <td>
              <?php
                if ($result['status_pengajuan']=="Diterima" or $result['status_pengajuan']=="Diterima") {
              ?>
