...
function uploadBerkas(){
    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allowEkstensi)==TRUE){
            ...
            $sql = "Call updateMutasi('$id','$no_reg','$no_surat_perjanjian', '$penjual_nama', '$penjual_tanggal_lahir', '$penjual_alamat', '$pembeli_nama', '$pembeli_tanggal_lahir', '$pembeli_alamat', '$no_kikitir', '$no_persil', '$ds', '$batas_tanah', '$luas_tanah', '$harga', '$mutlak_akad', '$ajb', '$sertifikat', '$pph'
            ,'$status','$statusTanah')";
            ...
            if ($conn->query($sql) === true) {
                ...
                echo '<script language="javascript">';
                echo 'alert("Data sukses terdaftar"); location.href="http://localhost/warga_mutasi"';
                echo '</script>';
            } else {
