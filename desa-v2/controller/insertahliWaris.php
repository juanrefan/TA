...
function uploadBerkas(){
    ...
    if($_POST['btnAction']){
        ...
        if(in_array($ekstension_file,$allowEkstensi) == TRUE){
            ...
            if ($files['file']['size'][0]>200000 AND $files['file']['size'][1]>200000 AND $files['file']['size'][2]>200000) {
                ...
                echo 'alert("Ukuran file melebihi kapasitas 200kb"); location.href="http://localhost/warga_ahli_Waris"';
                echo '</script>';
            ...
            if ($conn->query($sql) === true) {
             ...
             ?>
                   <script>
                    ...
                    location.href = "http://localhost/warga_ahli_waris";
                </script>
    ...
    echo '<script language="javascript">';
    echo 'alert("Tidak support jenis file"); location.href="http://localhost/warga_ahli_Waris"';
    echo '</script>';
}
