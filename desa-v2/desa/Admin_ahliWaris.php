...
<body>
<h2 align="center">Admin Table Ahli Waris</h2>

<div class="container">
            <div class="dropdown">
                <button type="button" class="btn btn-primary" data-toggle="dropdown" align="right">
                    Notifications <span class="badge badge-danger" id="notifahliwaris"></span>
                </button>
...
<div class="w3-container">
  ...
  <div class="w3-modal-content" style="width: 75%">
      <div class="w3-container">
        ...
        <form action="controller/insertahliwarisAdmin.php" method="POST" enctype="multipart/form-data">
            <div class="form-columns">
              ...
              <label for="tgl">Tanggal<span class="required">*</span></label>
                        ...
                        <input type="text" id="firstnameSuami" name="namaSuami" class="field-divided" placeholder="First" pattern="[A-Za-z]+" title="“Input tidak valid. Harap masukan karakter huruf (A-Z) tanpa angka atau simbol" required>
                            <!-- Alm Istri -->
                        <input type="checkbox" id="AlmSuami" name="fav_language" value="Istri">
                        <label for="html">Alm</label><br>
                        ...
                        <input type="checkbox" id="AlmIstri" name="fav_language" value="Istri">
                        <label for="html">Alm</label><br>
...
<!--              
  ...
  <div class="w3-modal-content" style="width: 75%">
      <div class="w3-container">
        ...
        <form action="controller/update_status_ahliWaris.php" method="POST" enctype="multipart/form-data">
            <div class="form-columns">
              <div class="form-style-1">
